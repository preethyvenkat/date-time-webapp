provisioner "local-exec" {
  command = <<EOT
    multipass exec jenkins-gitops-vm -- bash -c '
      ...
      T_VERSION="1.8.4"  # Replace with latest or pinned version you want
      curl -fsSL "https://releases.hashicorp.com/terraform/${T_VERSION}/terraform_${T_VERSION}_linux_arm64.zip" -o terraform.zip
      unzip terraform.zip
